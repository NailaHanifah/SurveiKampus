...
class DetailActivity : AppCompatActivity() {
    ...
    private val dataLaporan = arrayOf(
        LaporanFakultas(
            "FAKULTAS FISIP", R.drawable.kelas_fisip,
        ...
        LaporanFakultas(
            "FAKULTAS TI (FTI UNISKA)", R.drawable.kelas_ti,
        ...
        LaporanFakultas(
            "FAKULTAS FKIP", R.drawable.kelas_fkip,
        ...
        LaporanFakultas(
            "FAKULTAS HUKUM", R.drawable.kelas_hukum,
        ...
        LaporanFakultas(
            "FAKULTAS FEB", R.drawable.kelas_feb,
